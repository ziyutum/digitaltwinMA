...
class Program
{
    ...
    static void HandleMqttMessage(string payload, DateTime timestamp)
    {
        ...
        else if (payload.StartsWith("The Bottle is: At the Seperator      ,  Position:  At the Seperator"))
        {
            currentPosition = "At_Seperator";
        }

...
namespace CSClient
{
    class Program
    {
        ...
        static Timer m_downstreamTimer = new System.Timers.Timer(500); // Max length in ms
        static Timer m_maxTimeDownstream = new System.Timers.Timer(100000); // after that csv is created

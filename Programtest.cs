...
namespace uploadDTtoAzure
{
    class Program
    {
        ...
        static List<string> InstanceInitialDirectory =new List<string>
        {
             "../AzureDTDLs/Instances/FrankaRobot",
             "../AzureDTDLs/Instances/StorageZone",
             "../AzureDTDLs/Instances/GuideAxis",
             "../AzureDTDLs/Instances/TransportConveyer",
             "../AzureDTDLs/Instances/Bottleswitch",
             "../AzureDTDLs/Instances/myJoghurtProduct"
        };  
        static List<string> RelInitialDirectory =new List<string>
        {
             "../AzureDTDLs/Rels/FrankaRobot/FrankaRobotRels.json",
             "../AzureDTDLs/Rels/StorageZone/StorageZoneRels.json",
             "../AzureDTDLs/Rels/GuideAxis/GuideAxisRels.json",
             "../AzureDTDLs/Rels/TransportConveyer/TransportConveyerRels.json",
             "../AzureDTDLs/Rels/Bottleswitch/BottleswitchRels.json",
             "../AzureDTDLs/Rels/myJoghurtProduct/myJoghurtProductRels.json"
        };

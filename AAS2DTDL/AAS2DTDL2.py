...
if __name__=="__main__":
    ...
    object_store, file_store = load_aas_data(package_name=package_name)
        ...
        # Create directory structure to store the dtdl files
    ...
    if not os.path.exists(os.getcwd()+"/AzureDTDLs/Instances/FrankaRobot"):
        os.makedirs(os.getcwd()+"/AzureDTDLs/Instances/FrankaRobot")
    if not os.path.exists(os.getcwd()+"/AzureDTDLs/Rels"):
        os.makedirs(os.getcwd()+"/AzureDTDLs/Rels")
    if not os.path.exists(os.getcwd()+"/AzureDTDLs/Rels/FrankaRobot"):
        os.makedirs(os.getcwd()+"/AzureDTDLs/Rels/FrankaRobot")
    ...
    dtdl_instance_creator.writeInstanceFiles("FrankaRobot")

    # Create the relationships
    graph_creator = TwinGraphRelationshipCreator(object_store)
    graph_creator.generateRelationshipsData()
    graph_creator.writeRelationshipFile("FrankaRobot", "/FrankaRobotRels")

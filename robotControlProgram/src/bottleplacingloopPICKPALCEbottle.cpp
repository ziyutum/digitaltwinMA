...
// Function to move robot back to initial position and send data via TCP
         ...
         // below is the code for the bottle fetching actions
         //-----------------------------------------------------------------------------------------------------------------------------------------------------------
         // to fetch the bottle
        //  std::this_thread::sleep_for(std::chrono::seconds(5));
        //  gripper.move(0.03, 0.01);
        ...
        //     myRobot.control([&](const franka::RobotState& rstate, franka::Duration periode) -> franka::CartesianPose {
        //         return cartesian_motion(initial_pos11, time12, finish_time12, gw12, displacement12, client_socket, message_count, rstate, periode);
        //     });
